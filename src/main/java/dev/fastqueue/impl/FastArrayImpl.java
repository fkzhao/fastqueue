...
public class FastArrayImpl implements FastArray {
     ...
     */
    public FastArrayImpl(String arrayDir, String arrayName) throws IOException {
     ...
     * @throws IOException exception throws during array initialization
     */
    public FastArrayImpl(String arrayDir, String arrayName, int pageSize) throws IOException {
    ...
    // find out array head/tail from the metadata
