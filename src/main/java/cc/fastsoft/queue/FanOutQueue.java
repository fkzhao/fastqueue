...
public interface FanOutQueue extends Closeable {
     ...
     * Note, this is the best effort call, exact size limit can't be guaranteed
     *
     ...
     * to find the earliest index, use {@link #EARLIEST} as timestamp.
     *
